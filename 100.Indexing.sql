...
CREATE UNIQUE  INDEX idx_concept_concept_id ON cohort_cdm.concept (concept_id ASC);
...
CREATE UNIQUE  INDEX idx_vocabulary_vocabulary_id ON cohort_cdm.vocabulary (vocabulary_id ASC);
--CREATE UNIQUE  INDEX idx_domain_domain_id ON domain (domain_id ASC);
CREATE UNIQUE  INDEX idx_concept_class_class_id ON cohort_cdm.concept_class (concept_class_id ASC);
...
CREATE UNIQUE  INDEX idx_relationship_rel_id ON cohort_cdm.relationship (relationship_id ASC);
CREATE  INDEX idx_concept_syym_id ON cohort_cdm.concept_syym (concept_id ASC);
CREATE  INDEX idx_concept_ancestor_id_1 ON cohort_cdm.concept_ancestor (ancestor_concept_id ASC);
...
CREATE  INDEX idx_drug_strength_id_1 ON cohort_cdm.drug_strength (drug_concept_id ASC);
...
CREATE UNIQUE  INDEX idx_person_id ON cohort_cdm.person (person_id ASC);

CREATE  INDEX idx_observation_period_id ON cohort_cdm.observation_period (person_id ASC);

CREATE  INDEX idx_specimen_person_id ON cohort_cdm.specimen (person_id ASC);

CREATE INDEX idx_specimen_concept_id ON cohort_cdm.specimen (specimen_concept_id ASC);

CREATE  INDEX idx_death_person_id ON cohort_cdm.death (person_id ASC);

CREATE  INDEX idx_visit_person_id ON cohort_cdm.visit_occurrence (person_id ASC);

CREATE INDEX idx_visit_concept_id ON cohort_cdm.visit_occurrence (visit_concept_id ASC);

CREATE  INDEX idx_procedure_person_id ON cohort_cdm.procedure_occurrence (person_id ASC);
...
CREATE  INDEX idx_drug_person_id ON cohort_cdm.drug_exposure (person_id ASC);
...
CREATE  INDEX idx_device_person_id ON cohort_cdm.device_exposure (person_id ASC);
...
CREATE  INDEX idx_condition_person_id ON cohort_cdm.condition_occurrence (person_id ASC);
...
CREATE  INDEX idx_measurement_person_id ON cohort_cdm.measurement (person_id ASC);
...
CREATE  INDEX idx_note_person_id ON cohort_cdm.note (person_id ASC);
...
CREATE  INDEX idx_observation_person_id ON cohort_cdm.observation (person_id ASC);
...
CREATE  INDEX idx_period_person_id ON cohort_cdm.payer_plan_period (person_id ASC);
...
CREATE  INDEX idx_drug_era_person_id ON cohort_cdm.drug_era (person_id ASC);

CREATE INDEX idx_drug_era_concept_id ON cohort_cdm.drug_era (drug_concept_id ASC);

CREATE  INDEX idx_dose_era_person_id ON cohort_cdm.dose_era (person_id ASC);

CREATE INDEX idx_dose_era_concept_id ON cohort_cdm.dose_era (drug_concept_id ASC);

CREATE  INDEX idx_condition_era_person_id ON cohort_cdm.condition_era (person_id ASC);
 ...
 **********************************/
 ...
 /* PERSON */
	...
	CREATE  INDEX [<PERSON_2, sysname,>]
		ON cohort_cdm.PERSON ([location_id])
			INCLUDE ([person_id]);

				 

	CREATE  INDEX [<PERSON_3, sysname,>]
		ON cohort_cdm.PERSON ([provider_id]);

				

	CREATE  INDEX [<PERSON_4, sysname,>]
		ON cohort_cdm.PERSON ([care_site_id]);

			
/* OBSERVATION */ 
	CREATE  INDEX [<OBSERVATION_1, sysname,>]
		ON cohort_cdm.[OBSERVATION] ([provider_id]);
	CREATE  INDEX [<OBSERVATION_2, sysname,>]
		ON cohort_cdm.[OBSERVATION] ([visit_occurrence_id]);
	CREATE  INDEX [<OBSERVATION_3, sysname,>]
...
/* OBSERVATION_PERIOD */
	...
	CREATE  INDEX [<OBSERVATION_PERIOD_4, sysname,>]
		ON cohort_cdm.[OBSERVATION_PERIOD] ([PERSON_ID])
			INCLUDE ([OBSERVATION_PERIOD_START_DATE]);

			 

	CREATE  INDEX [<OBSERVATION_PERIOD_5, sysname,>]
...
/* CONDITION */
	...
	CREATE  INDEX [<CONDITION_1, sysname,>]
		ON cohort_cdm.[CONDITION_OCCURRENCE] ([provider_id]);

		

	CREATE  INDEX [<CONDITION_2, sysname,>]
...
/* CONDITION_ERA */
	...
	CREATE  INDEX [<CONDITION_ERA_1, sysname,>]
...
/* PROCEDURE */
	...
	CREATE  INDEX [<PROCEDURE_1, sysname,>]
...
/* DRUG_ERA */
	...
	CREATE  INDEX [<DRUG_ERA_1, sysname,>]
...
/* PROVIDER */
	...
	CREATE  INDEX [<PROVIDER_1, sysname,>]
...
/* PAYER_PLAN_PERIOD */
	...
	CREATE  INDEX [<PAYER_PLAN_PERIOD_1, sysname,>]
...
/* ACHILLES_results */
	...
	--CREATE  INDEX [<ACHILLES_RESULTS, sysname,>]
		--ON cohort_cdm.[ACHILLES_results] ([count_value]);
